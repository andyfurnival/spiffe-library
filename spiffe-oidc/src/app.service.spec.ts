...
describe('AppService', () => {
  ...
  it( 'token should be decoded and spiffeID generated', async() =>{
    expect(await service.generateSpiffeID(TokenSet)).toBe("spiffe://fs.server.com/user/roles:admin,public/")
  })
});
